...
public:
    ...
    void print()
    {
        cout<<"Process ID ="<<id<<" AT= "<<At<<", BT="<<Bt<<", CT= "<<Ct<<", WT= "<<Wt<<", AWT= "<<AWT<<", TAT= "<<Tat<<endl;
    }
/// SJF
/// A <  B , jar BT kom, se age ashbe.
/// A < B    Jar BT kom, se boro.
/// dui ta process A & B er moddhe, jar BT boro, se choto.
